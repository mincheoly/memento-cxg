...
from memento import diff_expr
from memento.cell_census_summary_cube import CUBE_LOGICAL_DIMS_OBS, ESTIMATOR_NAMES, CUBE_DIMS_VAR
...
def estimators_df(dim_counts: Dict[str, int]) -> pd.DataFrame:
    ...
    columns = CUBE_LOGICAL_DIMS_OBS + CUBE_DIMS_VAR
    ...
    for c, estimator in enumerate(ESTIMATOR_NAMES, start=1):
...
def test_setup(estimators_df: pd.DataFrame):
    ...
    assert design.to_dict(orient='records') == \
           [{'cell_type_cell_type_b': 0, 'dataset_id_dataset_id_b': 0, 'dataset_id_dataset_id_c': 0,
             'assay_assay_b': 0},
            {'cell_type_cell_type_b': 0, 'dataset_id_dataset_id_b': 0, 'dataset_id_dataset_id_c': 0,
             'assay_assay_b': 1},
            {'cell_type_cell_type_b': 0, 'dataset_id_dataset_id_b': 1, 'dataset_id_dataset_id_c': 0,
             'assay_assay_b': 0},
            {'cell_type_cell_type_b': 0, 'dataset_id_dataset_id_b': 1, 'dataset_id_dataset_id_c': 0,
             'assay_assay_b': 1},
            {'cell_type_cell_type_b': 0, 'dataset_id_dataset_id_b': 0, 'dataset_id_dataset_id_c': 1,
             'assay_assay_b': 0},
            {'cell_type_cell_type_b': 0, 'dataset_id_dataset_id_b': 0, 'dataset_id_dataset_id_c': 1,
             'assay_assay_b': 1},
            {'cell_type_cell_type_b': 1, 'dataset_id_dataset_id_b': 0, 'dataset_id_dataset_id_c': 0,
             'assay_assay_b': 0},
            {'cell_type_cell_type_b': 1, 'dataset_id_dataset_id_b': 0, 'dataset_id_dataset_id_c': 0,
             'assay_assay_b': 1},
            {'cell_type_cell_type_b': 1, 'dataset_id_dataset_id_b': 1, 'dataset_id_dataset_id_c': 0,
             'assay_assay_b': 0},
            {'cell_type_cell_type_b': 1, 'dataset_id_dataset_id_b': 1, 'dataset_id_dataset_id_c': 0,
             'assay_assay_b': 1},
            {'cell_type_cell_type_b': 1, 'dataset_id_dataset_id_b': 0, 'dataset_id_dataset_id_c': 1,
             'assay_assay_b': 0},
            {'cell_type_cell_type_b': 1, 'dataset_id_dataset_id_b': 0, 'dataset_id_dataset_id_c': 1,
             'assay_assay_b': 1}]
