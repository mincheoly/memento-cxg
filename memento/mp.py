...
def n_workers_from_memory_budget(per_worker_budget: int, max_worker_processes: int,) -> int:
...
def create_process_pool_executor(max_worker_processes: int, max_workers: Optional[int] = None,
                                 process_init=None,
                                 init_args: Tuple[Any, ...] = ()) -> ProcessPoolExecutor:
    ...
    return ProcessPoolExecutor(max_workers=max_workers, initializer=process_init,
                               initargs=init_args)
...
def create_resource_pool_executor(
    ...
    process_init: Optional[Callable] = None,
